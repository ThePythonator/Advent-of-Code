...
def solve(lines):
    ...
    for i in range(len(lines[0])):
        result = max(result, simulate(lines, (i, 0), 1))
        result = max(result, simulate(lines, (i, len(lines) - 1), 3))
    
    for i in range(len(lines)):
        result = max(result, simulate(lines, (0, i), 0))
        result = max(result, simulate(lines, (len(lines) - 1, i), 2))
    return result
