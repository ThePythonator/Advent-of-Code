...
def solve(lines):
    ...
    # TODO: use idea from hacky.py but make generic

    # for i in range(1000000):
    #     for v in valid_suffixes:
    #         registers[0] = reg_a = (i << 36) + v
    #         result = _solve(registers.copy(), program)
    #         if result[:idx] == program[:idx]:
    #             next_valid.add(bin(j)[-(idx*3):])
...
with open(os.path.join(SCRIPT_PATH, "sample_part2.txt")) as f:
